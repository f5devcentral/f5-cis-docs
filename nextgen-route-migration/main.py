...
def validate_inputs(cli_args):
    if 'cis_file' not in cli_args and 'cis_name' not in cli_args:
        logging.error("Either provide cis_file (CIS deployment yaml file) or cis_name (name of the CIS deployment in "
...
if __name__ == '__main__':
    try:
        ...
        elif 'cis_deploy' in args_values:
            cis_deploy_obj = utils.get_deploy_res_from_deploy(args_values['cis_deploy'])
        else:
