...
![architecture](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/eks-anywhere/ingresslink/diagram/2021-08-17_12-08-07.png)
...
* NGINX+ IC [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/eks-anywhere/ingresslink/nginx-config)
...
proxy_protocol_iRule [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/eks-anywhere/ingresslink/big-ip/proxy-protocal/irule)
...
cis-crd-schema [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/eks-anywhere/ingresslink/cis/cis-crd-schema/customresourcedefinition.yaml)
...
cis-deployment [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/eks-anywhere/ingresslink/cis/cis-deployment/f5-cis-deployment.yaml)
...
crd-schema [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/eks-anywhere/ingresslink/nginx-config/crd-schema)
...
nginx-config [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/eks-anywhere/ingresslink/nginx-config)
...
crd-resource [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/eks-anywhere/ingresslink/cis/crd-resource/vs-ingresslink.yaml)
...
```
cafe application [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/eks-anywhere/ingresslink/ingress-example)
...
![coffee](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/eks-anywhere/ingresslink/diagram/2021-08-17_12-39-25.png)

If your prefer tea:

![tea](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/eks-anywhere/ingresslink/diagram/2021-08-17_12-39-01.png)
...
![virtual server list](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/eks-anywhere/ingresslink/diagram/2021-08-17_12-53-53.png)

To view the IngressLink pool members:

![pool members](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/eks-anywhere/ingresslink/diagram/2021-08-17_12-54-23.png)

To view the IngressLink pool:

![pool list](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/eks-anywhere/ingresslink/diagram/2021-08-17_12-54-47.png)

To view the IngressLink pool members for port 443:

![pool members 443](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/eks-anywhere/ingresslink/diagram/2021-08-17_12-55-08.png)

To view the IngressLink pool members for 192.168.200.26:

![pool members 192.168.200.26](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/eks-anywhere/ingresslink/diagram/2021-08-17_13-27-07.png)
