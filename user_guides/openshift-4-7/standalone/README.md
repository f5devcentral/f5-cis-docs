...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-7/standalone/diagram/2021-06-30_13-40-08.png)
...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-7/standalone/diagram/2021-06-30_14-35-58.png)
...
```
f5-openshift-hostsubnet.yaml [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-7/standalone/cis/f5-openshift-hostsubnet.yaml)
...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-7/standalone/diagram/2021-06-30_14-38-24.png)
...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/operator/diagrams/2021-06-10_12-59-30.png)
...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/operator/diagrams/2021-06-10_13-20-27.png)
...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/operator/diagrams/2021-06-10_13-47-45.png)

Operator will take a few minutes to install

![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/operator/diagrams/2021-06-10_13-50-10.png)

Once installed select the View Operator tab

![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/operator/diagrams/2021-06-10_13-51-02.png)

Now that the operator is installed you can create an instance of CIS. This will deploy CIS in OpenShift

![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/operator/diagrams/2021-06-14_14-07-36.png)
...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/operator/diagrams/2021-06-14_14-14-41.png)
...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/operator/diagrams/2021-06-14_14-42-54.png)

Select the **f5-bigip-ctlr-operator** to see more details on the CIS deployment. Also validate the CIS deployment image

![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/operator/diagrams/2021-06-14_14-45-08.png)
...
```
demo-app [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/openshift-4-7/standalone/demo-app)

You can validate the demo app install via the OpenShift UI

![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-7/standalone/diagram/2021-06-30_11-39-52.png)
...
f5-demo-route-basic [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-7/standalone/route/f5-demo-route-basic.yaml)
...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-7/standalone/diagram/2021-06-30_14-00-53.png)