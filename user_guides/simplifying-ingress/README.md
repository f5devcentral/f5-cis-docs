...
![architecture](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/simplifying-ingress/diagram/2021-10-15_14-05-41.png)
...
cis-deployment [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/simplifying-ingress/cis/cis-deployment)
    
### Create CIS CRD schema

    kubectl create -f customresourcedefinition.yaml

cis-crd-schema [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/simplifying-ingress/cis/cis-crd-schema/customresourcedefinition.yaml)
...
cis-deployment [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/simplifying-ingress/cis/cis-deployment/f5-cis-deployment.yaml)

### Configure BIG-IP as a node in the Kubernetes cluster. This is required for OVN Kubernetes using ClusterIP

    kubectl create -f f5-bigip-node.yaml

bigip-node [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/simplifying-ingress/cis/cis-deployment/f5-bigip-node.yaml)
...
```
ipam-deployment [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/simplifying-ingress/ipam-deployment)
...
![CRD](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/simplifying-ingress/diagram/2021-10-18_14-30-40.png)
...
nginx-config [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/simplifying-ingress/nginx-config)
...
ingress-example [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/simplifying-ingress/ingress-example)
...
![CRD](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/simplifying-ingress/diagram/2021-10-18_14-50-41.png)

Connext to Cafe App for Coffee and Tea

* cafe.example.com/coffee

![CRD](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/simplifying-ingress/diagram/2021-10-18_14-53-03.png)

* cafe.example.com/tea

![CRD](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/simplifying-ingress/diagram/2021-10-18_14-53-34.png)