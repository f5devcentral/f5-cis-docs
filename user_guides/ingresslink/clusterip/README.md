...
![architecture](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/ingresslink/clusterip/diagram/2021-03-01_15-41-39.png)
...
proxy_protocol_iRule [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/ingresslink/clusterip/big-ip/proxy-protocal/irule)
...
cis-crd-schema [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/ingresslink/clusterip/cis/cis-crd-schema/customresourcedefinition.yaml)
...
cis-deployment [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/ingresslink/clusterip/cis/cis-deployment/f5-cis-deployment.yaml)

Configure BIG-IP as a node in the Kubernetes cluster. This is required for OVN Kubernetes using ClusterIP

    kubectl create -f f5-bigip-node.yaml

bigip-node [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/ingresslink/clusterip/cis/cis-deployment/f5-bigip-node.yaml)
...
```
nginx-config [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/ingresslink/clusterip/nginx-config)
...
crd-resource [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/ingresslink/clusterip/cis/crd-resource/vs-ingresslink.yaml)
...
demo application [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/ingresslink/clusterip/ingress-example)
