...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/prometheus/diagrams/2021-06-03_14-03-16.png)
...
```
Create a file named clusterRole.yaml. Locate the clusterRole.yaml file from my repo [yaml](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/prometheus/prometheus-deployment/clusterRole.yaml)
```
...
Create a file called config-map.yaml. Locate the config-map.yaml file from my repo [yaml](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/prometheus/prometheus-deployment/config-map.yaml)
```
...
Create a file named prometheus-deployment.yaml. Locate the prometheus-deployment.yaml file from my repo [yaml](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/prometheus/prometheus-deployment/prometheus-deployment.yaml)
```
...
Create the service using the following command. Locate the prometheus-service.yaml file from my repo [yaml](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/prometheus/prometheus-deployment/prometheus-service.yaml)
...
Create the Ingress using the following command. Locate the prometheus-ingress.yaml file from my repo [yaml](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/prometheus/prometheus-deployment/prometheus-ingress.yaml)
...
![Image of CRDs](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/prometheus/diagrams/2020-05-11_16-28-32.png)
...
![Image of Target](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/prometheus/diagrams/2021-06-03_15-09-19.png)

Many metrics are available to graph or monitor. Example below virtualServers current connections. Use the label to graph the metric desired.
```
...
![Image of graph](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/prometheus/diagrams/2020-05-12_16-08-21.png)
