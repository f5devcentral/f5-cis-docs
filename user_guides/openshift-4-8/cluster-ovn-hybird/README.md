...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-8/cluster-ovn-hybird/diagram/2021-08-10_14-39-33.png)
...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-8/cluster-ovn-hybird/diagram/2021-08-03_13-12-08.png)
...
```
install-config.yaml.yaml [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-7/standalone/openshift/install-config.yaml)
...
```
cluster-network-03-config.yaml [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-8/cluster-ovn-hybird/openshift/cluster-network-03-config.yaml)
...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-8/cluster-ovn-hybird/diagram/2021-08-03_14-18-36.png)
...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-8/cluster-ovn-hybird/diagram/2021-08-06_14-06-18.png)
...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-8/cluster-ovn-hybird/diagram/2021-08-06_14-06-50.png)
...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-8/cluster-ovn-hybird/diagram/2021-08-06_14-20-14.png)
...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-8/cluster-ovn-hybird/diagram/2021-08-06_14-20-46.png)
...
![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-8/cluster-ovn-hybird/diagram/2021-08-06_14-33-20.png)

Diagram of self-ip addresses on the BIG-IP devices

* **bigip-01**

![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-8/cluster-ovn-hybird/diagram/2021-08-06_14-35-28.png)

* **bigip-02**

![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-8/cluster-ovn-hybird/diagram/2021-08-06_14-35-55.png)
...
cis-deployment [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/openshift-4-7/cluster/cis)

Validate that both CIS POD are running. You can use the OpenShift dashboard to view the deployments

![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-8/cluster-ovn-hybird/diagram/2021-08-06_14-51-12.png)
...
ocp-exgw.yaml [repo](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-8/cluster-ovn-hybird/openshift/ocp-exgw.yaml)
...
f5-demo-route-basic [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/openshift-4-8/cluster-ovn-hybird/route)

Validate the route via the OpenShift UI under the Networking/Routes

![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-7/standalone/diagram/2021-06-30_13-59-43.png)

Validate the route via the BIG-IP

![diagram](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/openshift-4-8/cluster-ovn-hybird/diagram/2021-08-06_15-35-49.png)