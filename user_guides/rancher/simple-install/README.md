...
* Install the Helm chart using the following command:
    ...
    helm install -f https://raw.githubusercontent.com/f5devcentral/f5-cis-docs/main/user_guides/rancher/simple-install/cis-deployment/cis-k8s-custom-resource-values.yaml f5-bigip-ctlr f5-stable/f5-bigip-ctlr
...
![installed-apps](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/rancher/simple-install/diagrams/2021-11-10_13-10-48.png)

Validate that CIS is deployed and running from the Deployment tab in the Rancher Dashboard

![validate](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/rancher/simple-install/diagrams/2021-11-10_13-19-00.png)

Select the **Deployment: f5-bigip-ctlr** from the Deployment tab in the Rancher Dashboard

![validate](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/rancher/simple-install/diagrams/2021-11-10_13-22-43.png)
