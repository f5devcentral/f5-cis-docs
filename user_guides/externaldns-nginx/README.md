...
![architecture](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/externaldns-nginx/diagram/2022-01-13_10-37-44.png)
...
cis-deployment [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/externaldns-nginx/cis/cis-deployment)
...
```
ipam-deployment [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/externaldns-nginx/ipam-deployment)

View the following guide to help troubleshooting IPAM [IPAM](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/ipam)
...
nginx-config [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/externaldns-nginx/nginx-config)
...
ingress-example [repo](https://github.com/f5devcentral/f5-cis-docs/tree/main/user_guides/externaldns-nginx/ingress-example)
...
![VirtualServer](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/externaldns-nginx/diagram/2022-01-13_14-29-16.png)
...
![Wide IP](https://github.com/f5devcentral/f5-cis-docs/blob/main/user_guides/externaldns-nginx/diagram/2022-01-13_14-20-27.png)